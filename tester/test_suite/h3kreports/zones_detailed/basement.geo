...
# no  name         type  posn  name         other side
  1, found_lft2    OPAQ  VERT  ccht_wall    GROUND       
  2, found_frnt2   OPAQ  VERT  foundation_  GROUND       
  3, found_lft1    OPAQ  VERT  foundation_  GROUND       
  4, bsment_ceiln  OPAQ  CEIL  floors_r     mainfloor      
  5, bsment_floor  OPAQ  FLOR  slab_floor   GROUND       
  ...
  9, found_rgt2    OPAQ  VERT  foundation_  GROUND       
 10, found_rgt1    OPAQ  VERT  foundation_  GROUND       
 11, found_frnt1   OPAQ  VERT  foundation_  GROUND       
 12, found_back    OPAQ  VERT  foundation_  GROUND       
# base
   5   0   0   0   0   0   102.87
