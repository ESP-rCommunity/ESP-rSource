...
# plant component: water flow source - temperature
  ...
  2.                # No. of data items
  2.0 1.0           # corresponding BC column, and interpolation method (1=step)
* Control loops
# measures dummy sensor
  -1    1    1    0 # sensor
# plant component: water flow source - temperature
  -1    1    2    0 # actuator ( src component flow )
  1                 # No. day types
  1  365            # valid Fri  1 Jan - Fri 30 Apr
  1                 # No. of periods in day
  0   12  0.000     # ctl type, law (Boundary condition control), start @
...
# plant component: SE control mode
  ...
  0   12  0.000     # ctl type, law (Boundary condition control), start @
  2.                # No. of data items
  4.00 1.00         # corresponding BC column, and interpolation method (1=step)
* Control loops
# measures dummy sensor
  -1    1    1    0 # sensor
# plant component: SE control mode
  -1    2    2    0 # actuator: SE operating target (W)
  1                 # No. day types
  1  365            # valid Fri  1 Jan - Fri 30 Apr
  1                 # No. of periods in day
  0   12  0.000     # ctl type, law (Boundary condition control), start @
  2.                # No. of data items
  5.00 1.00         # corresponding BC column, and interpolation method (1=step)
