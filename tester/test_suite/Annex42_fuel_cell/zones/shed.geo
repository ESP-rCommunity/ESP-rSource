*Geometry 1.1,GEN,shed # tag version, format, zone name
*date Wed May  5 17:36:56 2021  # latest file modification 
shed describes a shed that holds the SOFC-cogen unit
...
*surf,Surf-5,CEIL,-,-,-,extern_wall,OPAQUE,EXTERIOR,000,000  #   5 ||< external
