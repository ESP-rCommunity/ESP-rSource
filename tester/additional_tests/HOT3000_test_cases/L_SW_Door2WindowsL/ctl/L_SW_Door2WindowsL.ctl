control for L_SW_Door2WindowsL  # overall descr 
* Building
...
7  # No. of data items
25000.000 0.000 0.000 0.000 21.000 100.000 0.000   #  MaxHtgCap/MinHtgCap/MaxClCap/MinClCap/HtgStPt/ClStPt/
#    >>>>Day Type: 1 - Period: 2<<<<
...
* Control Function # 3[attic] 
# senses dry bulb temperature in attic
    0    0    0    0    0  # sensor data
# actuates air point of the current zone
    0    0    0    0  # actuator data
    1 # No. day types
