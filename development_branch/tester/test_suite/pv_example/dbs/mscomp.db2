...
10.      Capacity at operating temperature (Ah/cell)
...
60.      Initial battery temperature (oC)
0.       Initial battery depth of discharge (-)
10000.   Thermal mass of the battery (J/oC)
20.      Battery heat loss coefficient (W/oC)
100.     Resistance of the heating elements (ohms)
50.      Temperature below which the thermal management system takes priority (oC)
...
*TEXT
Battery model developed by CETC (Patrice Pinel).
*ENDTEXT
*END
*POWOCOMP
*IDDATA
