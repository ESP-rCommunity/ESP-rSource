# complex fenestration construction properties of zone2 defined in ../zones/zone2.cfc
   8   # surfaces
...
# slat: width(mm); spacing(mm); angle(deg); orientation(HORZ/VERT); crown (mm); w/r ratio; slat thickness (mm)
  25.400  21.170  89.000  VERT    0.000   0.000   0.330
...
# slat: width(mm); spacing(mm); angle(deg); orientation(HORZ/VERT); crown (mm); w/r ratio; slat thickness (mm)
  25.400  21.170  89.000  VERT    1.610   0.499   0.330
