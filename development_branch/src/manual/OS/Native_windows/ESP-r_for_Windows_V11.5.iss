...
OutputBaseFilename=ESP-r_setup_native_windows_v11.5
VersionInfoVersion=11.5
VersionInfoCompany=ESRU and others
VersionInfoDescription=version 11.5 for native windows
VersionInfoCopyright=ESRU and others 2001-2008
Compression=zip
MinVersion=0,5.0.2195
AppCopyright=Copywrite ESRU and Natural Resources Canada 2001-2008
AppName=ESP-r for Windows
AppVerName=ESP-r for Windows V11.5
