# geometry of 210 defined in: 210.geo
GEN  210  210 describes a...  # type, name, descr
...
# no  name         type  posn  name         other side
  1, South_Wall    OPAQ  VERT  LWextwall2   EXTERIOR       
  2, South_Wall2   OPAQ  VERT  LWextwall2   EXTERIOR       
  3, East_Wall     OPAQ  VERT  LWextwall2   EXTERIOR       
  4, North_Wall    OPAQ  VERT  LWextwall2   EXTERIOR       
  5, West_Wall     OPAQ  VERT  LWextwall2   EXTERIOR       
  6, Window        OPAQ  VERT  op_glass2    EXTERIOR       
  7, Window2       OPAQ  VERT  op_glass2    EXTERIOR       
  8, Roof          OPAQ  CEIL  LWroof2      EXTERIOR       
