...
# actuates the air point in reception.
    1    0    0  # actuator data
    2 # No. day types
  187  190  # valid Thu  6 Jul - Sun  9 Jul
...
# plant component   5:5 @ node no.  1
  ...
  187  190  # valid Thu  6 Jul - Sun  9 Jul
    ...
    1    2   0.000  # ctl type, law (PID flow control.), start @
      7.  # No. of data items
  4.000 0.000 0.001 26.000 1.000 1000.000 1.000
  191  194  # valid Mon 10 Jul - Thu 13 Jul
     1  # No. of periods in day
    1    2   0.000  # ctl type, law (PID flow control.), start @
      7.  # No. of data items
  4.000 0.010 0.001 26.000 1.000 1000.000 1.000
* Control loops
# senses dry bulb temperature in office.
    2    0    0    0  # sensor 
# plant component   7:7 @ node no.  1
  ...
  187  190  # valid Thu  6 Jul - Sun  9 Jul
    ...
    0    1   0.000  # ctl type, law (PID flux control.), start @
      7.  # No. of data items
  -4.000 0.000 0.000 13.000 1.000 5.000 1.000
  191  194  # valid Mon 10 Jul - Thu 13 Jul
     1  # No. of periods in day
    0    1   0.000  # ctl type, law (PID flux control.), start @
      7.  # No. of data items
  -4.000 920.000 0.000 13.000 1.000 5.000 1.000
