# geometry of corridor defined in: ../zones/corridor.geo
GEN  corridor  corridor describes passage adjacent to offices  # type, name, descr
...
# no  name         type  posn  name         other side
  ...
  4, ceiling       OPAQ  CEIL  ceiling      SIMILAR        
  5, floor         OPAQ  FLOR  susp_flr_re  SIMILAR        
