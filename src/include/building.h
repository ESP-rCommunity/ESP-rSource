C ESP-r building-related definition file defining maximum
C parameter values.
...
C Type declarations.
      ...
      integer MCNDV,MCNDC,MPICK,MVAR,MSPMRES
...
C Construction.
      ...
      PARAMETER (MMLC=80)	!- Multilayered constructions in model.
...
C Results analysis.
      ...
      PARAMETER (MNFA=5)	!- Factorial analyses.
      PARAMETER (MNRS=2**MNFA)	!- Result sets.
      PARAMETER (MIPVM=MSPS)	!- IPV metrics.
      PARAMETER (MIPVA=MSPS)	!- IPV assessments.
      PARAMETER (MZS=90)	!- Number of items to report.
      PARAMETER (MZRL=MS+12)	!- Fields in a zone results library record
                                !  (set to larger of MCOM, MS+12 or 36).
