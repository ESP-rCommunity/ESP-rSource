...
C Zone control functions, day types, periods in day.
      PARAMETER (MCF=16,MBCDT=10,MBCDP=8)
...
C angles at which optical data is held.
      PARAMETER (MTMC=5,MGAL=2,MANG=9)
...
C results library (i.e. is = nzrl). Should be larger of either MS or MCOM or MS+12 or 36.
      PARAMETER (MZRL=36)
...
C 'mcub' is the number of MRT sensors in a zone.
      PARAMETER (MCUB=4,MGC=1000,MPATCH=200)
