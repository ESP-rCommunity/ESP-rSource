# geometry of floor defined in: ../zones/floor.geo
GEN  floor  floor is a thin zone representing piping for floor heating  # type, name, descr
      20       9   0.000    # vertices, surfaces, rotation angle
#  X co-ord, Y co-ord, Z co-ord
      0.00000     0.00000    -0.20000  # vert   1
      6.10000     0.00000    -0.20000  # vert   2
      6.10000     5.55000    -0.20000  # vert   3
      0.00000     5.55000    -0.20000  # vert   4
...
# no  name         type  posn  name         other side
  ...
  5, Surf-6        OPAQ  FLOR  structure    CONSTANT       
  6, floor_ma      OPAQ  CEIL  screed_rev   manager_a      
  7, floor_mb      OPAQ  CEIL  screed_rev   manager_b      
  8, floor_cor     OPAQ  CEIL  screed_rev   coridor        
  9, filler        OPAQ  CEIL  screed_rev   ADIABATIC      
# base
  6  5  0  0  0  0    47.35 0
