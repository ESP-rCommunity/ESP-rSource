 cntrl test
* Mass Flow
opens and closes windows based on time
   8  # No. of controls
* Control mass
# senses node (  1) liv
   -4    1    0    0  # sensor data
...
# actuates flow connection:  18 bath - north via bathex
   -3   18    0  # actuator data
    ...
    1    0   0.000  # ctl type (dry bulb > flow), law (on / off), start @
      1.  # No. of data items
  100.000
    1    0   5.990  # ctl type (dry bulb > flow), law (on / off), start @
      1.  # No. of data items
  0.000
...
# senses node (  3) bath
   -4    3    0    0  # sensor data
# actuates flow connection:  19 bath - north via bathpm
   -3   19    0  # actuator data
    ...
    1    0   0.000  # ctl type (dry bulb > flow), law (on / off), start @
      1.  # No. of data items
  100.000
    1    0  17.990  # ctl type (dry bulb > flow), law (on / off), start @
      1.  # No. of data items
  0.000
...
# senses node (  1) liv
   -4    1    0    0  # sensor data
# actuates flow connection:  20 ext_we - liv via winopn
   -3   20    0  # actuator data
    ...
    1    0   0.000  # ctl type (dry bulb > flow), law (on / off), start @
      1.  # No. of data items
  100.000
    1    0   7.990  # ctl type (dry bulb > flow), law (on / off), start @
      1.  # No. of data items
  22.000
...
# senses node (  6) buf_1
   -4    6    0    0  # sensor data
# actuates flow connection:  21 ext_we - buf_1 via winopn
  ...
  100.000
* Control mass
# senses node ( 13) buf_2
   -4   13    0    0  # sensor data
# actuates flow connection:  22 ext_ea - buf_2 via winopn
...
# senses node (  5) bed2
   -4    5    0    0  # sensor data
# actuates flow connection:  23 ext_ea - bed2 via winopn
...
# senses node (  4) bed1
   -4    4    0    0  # sensor data
# actuates flow connection:  24 ext_ea - bed1 via winopn
