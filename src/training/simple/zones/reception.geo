...
# no  name         type  posn  name         other side
  ...
  3, passage       OPAQ  VERT  gyp_blk_ptn  SIMILAR        
  4, north         OPAQ  VERT  extern_wall  EXTERIOR       
  5, part_a        OPAQ  VERT  extern_wall  EXTERIOR       
  6, part_b        OPAQ  VERT  extern_wall  EXTERIOR       
  7, west          OPAQ  VERT  extern_wall  EXTERIOR       
  8, ceiling       OPAQ  CEIL  roof_1       EXTERIOR       
  9, floor         OPAQ  FLOR  floor_1      CONSTANT       
 10, glz_s         TRAN  VERT  dbl_glz      EXTERIOR       
 11, door_p        OPAQ  VERT  door         EXTERIOR       
 12, door_a        OPAQ  VERT  door         EXTERIOR       
