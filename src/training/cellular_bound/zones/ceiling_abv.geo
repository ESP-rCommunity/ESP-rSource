# geometry of ceiling_abv defined in: ../zones/ceiling_abv.geo
GEN  ceiling_abv  ceiling_abv is a suspended ceiling above occupied space  # type, name, descr
      20       9   0.000    # vertices, surfaces, rotation angle
#  X co-ord, Y co-ord, Z co-ord
      0.00000     0.00000     3.50000  # vert   1
      6.10000     0.00000     3.50000  # vert   2
      6.10000     5.55000     3.50000  # vert   3
      0.00000     5.55000     3.50000  # vert   4
...
# no  name         type  posn  name         other side
  ...
  5, upper         OPAQ  CEIL  structure    boundary_up    
  6, floor_ma      OPAQ  FLOR  ceiling_rev  manager_a      
  7, floor_mb      OPAQ  FLOR  ceiling_rev  manager_b      
  8, floor_cor     OPAQ  FLOR  ceiling_rev  coridor        
  9, filler        OPAQ  FLOR  ceiling_rev  ADIABATIC      
# base
  6  5  7  8  9  0    67.71 0
