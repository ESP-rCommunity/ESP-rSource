...
# actuates air point of the current zone
    ...
    0    1   0.000  # ctl type, law (basic control), start @
      7.  # No. of data items
  1000.000 0.000 300.000 0.000 15.000 25.000 0.000
    0    1   6.000  # ctl type, law (basic control), start @
      7.  # No. of data items
  1000.000 0.000 300.000 0.000 19.000 24.000 0.000
  ...
  1000.000 0.000 300.000 0.000 19.000 24.000 0.000
    ...
    0    1   0.000  # ctl type, law (basic control), start @
      7.  # No. of data items
  1000.000 0.000 300.000 0.000 10.000 30.000 0.000
# Function:Zone links
 1,1,1
* Mass Flow
...
# actuates flow connection:  10 corid_left - manager_a via fan_8lps
   -3   10    0  # actuator data
    ...
    1    0   0.000  # ctl type (dry bulb > flow), law (on/off setpoint 50.00 direct action ON fraction 1.000.), starting @
      3.  # No. of data items
  50.00000 1.00000 1.00000
    1    0   8.500  # ctl type (dry bulb > flow), law (on/off setpoint 26.00 direct action ON fraction 1.000.), starting @
      3.  # No. of data items
...
# actuates flow connection:   4 man_bhi - manager_b via crack
   ...
   41    0   0.000  # ctl type (contam conc > flow), law (on/off setpoint 50.00 direct action ON fraction 1.000.), starting @
      3.  # No. of data items
  50.00000 1.00000 1.00000
   41    0   8.500  # ctl type (contam conc > flow), law (on/off setpoint 1.30 direct action ON fraction 1.000.), starting @
      3.  # No. of data items
