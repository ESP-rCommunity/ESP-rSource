# composite construction db defined in ../dbs/office_operations_constr.db2
...
# material ref thickness (m) description & air gap R
  ...
  211    0.1500  glasswool : Glasswool (generic)
    0    0.0500  gap  0.170 0.170 0.170
   22    0.1000  aerated conc block : Aerated concrete block
  108    0.0120  white gypboard : White painted Gypboard
# layers  description   optics name   symmetry tag
    3    insul_frame   OPAQ  OPAQUE        SYMMETRIC     
# material ref thickness (m) description & air gap R
...
# layers  description   optics name   symmetry tag
    1    fict          TRAN  SC_fictit     SYMMETRIC     
# material ref thickness (m) description & air gap R
  245    0.0060  fict : fictitious material (almost not there) with matching single laye
# layers  description   optics name   symmetry tag
