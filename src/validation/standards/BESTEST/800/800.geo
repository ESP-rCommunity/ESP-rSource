# geometry of 800 defined in: 800.geo
GEN  800  800 describes a...  # type, name, descr
...
# no  name         type  posn  name         other side
  1, South_Wall    OPAQ  VERT  HW_extwall   EXTERIOR       
  2, South_Wall2   OPAQ  VERT  HW_extwall   EXTERIOR       
  3, East_Wall     OPAQ  VERT  HW_extwall   EXTERIOR       
  4, North_Wall    OPAQ  VERT  HW_extwall   EXTERIOR       
  5, West_Wall     OPAQ  VERT  HW_extwall   EXTERIOR       
  6, Window        OPAQ  VERT  op_glass7    EXTERIOR       
  7, Window2       OPAQ  VERT  op_glass7    EXTERIOR       
  8, Roof          OPAQ  CEIL  HWroof       EXTERIOR       
  9, Floor         OPAQ  FLOR  HWfloor      GROUND         
# base
  9  0  0  0  0  0    48.00
