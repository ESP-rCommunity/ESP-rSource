# geometry of Test_12 defined in: zones/Test_12.geo
GEN  Test_12  Test_12 describes a...  # type, name, descr
...
# no  name         type  posn  name         other side
  ...
  5, Ceiling       OPAQ  CEIL  Typ_n.5_09em EXTERIOR       
  6, Floor         OPAQ  FLOR  T_n4fl09em0a ADIABATIC      
  7, window        TRAN  VERT  WISdblglz09e EXTERIOR       
# base
  6  0  0  0  0  0    19.80 0
