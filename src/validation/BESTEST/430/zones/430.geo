# geometry of 430 defined in: 430.geo
GEN  430  430 describes a...  # type, name, descr
...
# no  name         type  posn  name         other side
  1, South_Wall    OPAQ  VERT  LWextwall7   EXTERIOR       
  2, South_Wall2   OPAQ  VERT  LWextwall7   EXTERIOR       
  3, East_Wall     OPAQ  VERT  LWextwall7   EXTERIOR       
  4, North_Wall    OPAQ  VERT  LWextwall7   EXTERIOR       
  5, West_Wall     OPAQ  VERT  LWextwall7   EXTERIOR       
  6, Window        OPAQ  VERT  op_glass7    EXTERIOR       
  7, Window2       OPAQ  VERT  op_glass7    EXTERIOR       
  8, Roof          OPAQ  CEIL  LWroof7      EXTERIOR       
  9, Floor         OPAQ  FLOR  LWfloor7     GROUND         
# base
  9  0  0  0  0  0    48.00
