# geometry of 250 defined in: 250.geo
GEN  250  250 describes a...  # type, name, descr
...
# no  name         type  posn  name         other side
  1, South_Wall    OPAQ  VERT  LWextwall5   EXTERIOR       
  2, South_Wall2   OPAQ  VERT  LWextwall5   EXTERIOR       
  3, East_Wall     OPAQ  VERT  LWextwall5   EXTERIOR       
  4, North_Wall    OPAQ  VERT  LWextwall5   EXTERIOR       
  5, West_Wall     OPAQ  VERT  LWextwall5   EXTERIOR       
  6, Window        OPAQ  VERT  op_glass5    EXTERIOR       
  7, Window2       OPAQ  VERT  op_glass5    EXTERIOR       
  8, Roof          OPAQ  CEIL  LWroof5      EXTERIOR       
