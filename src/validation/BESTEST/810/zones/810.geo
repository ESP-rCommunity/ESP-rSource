# geometry of 810 defined in: 810.geo
GEN  810  810 describes a...  # type, name, descr
...
# no  name         type  posn  name         other side
  1, South_Wall    OPAQ  VERT  HW_extwall2  EXTERIOR       
  2, South_Wall2   OPAQ  VERT  HW_extwall2  EXTERIOR       
  3, East_Wall     OPAQ  VERT  HW_extwall2  EXTERIOR       
  4, North_Wall    OPAQ  VERT  HW_extwall2  EXTERIOR       
  5, West_Wall     OPAQ  VERT  HW_extwall2  EXTERIOR       
  6, Window        TRAN  VERT  dg_glazing   EXTERIOR       
  7, Window2       TRAN  VERT  dg_glazing   EXTERIOR       
  8, Roof          OPAQ  CEIL  HWroof2      EXTERIOR       
  9, Floor         OPAQ  FLOR  HWfloor2     GROUND         
# base
  9  0  0  0  0  0    48.00
