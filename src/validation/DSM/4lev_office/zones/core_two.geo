*Geometry 1.1,GEN,core_one # tag version, format, zone name
*date Mon Apr  2 12:37:13 2012  # latest file modification 
core_mid is the core at the first level
...
*surf,north_e1,VERT,-,-,-,partn_ltw,OPAQUE,ANOTHER,03,04  #   3 ||< north_2:office_e_1
...
*surf,north_c1_c,VERT,-,-,-,partn_ltw,OPAQUE,ANOTHER,17,04  #  12 ||< north_c2:ceiling_2
