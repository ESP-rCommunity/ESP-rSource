...
echo "ESP-r compile and use on Ubuntu 16.04."
echo "  "
...
echo "doing ... enscript psutils nedit nano..."
sudo apt-get install enscript psutils nedit nano
...
echo "doing ... xfonts-100dpi xfs font-manager..."
sudo apt-get install xfonts-100dpi xfs font-manager
echo "doing ... diffuse xfig transfig..."
sudo apt-get install diffuse xfig transfig
echo "  "
