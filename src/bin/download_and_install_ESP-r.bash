...
echo "Step 2 Downloading source...";
...
if [ "$platform" = "linux" ]  ||
   [ "$platform" = "cygwin" ] ||
   [ "$platform" = "mac" ] ; then
  echo "./Install -d /opt/esru --debug --X11 --gcc4 --silent --force";
fi
if [ "$platform" = "mingw" ] ; then
  echo "./Install -d C:/ESRU --debug --GTK --gcc4";
fi
